...
describe("flagAsExternal configuration | Integration", () => {
  ...
  describe("default behavior (backward compatibility)", () => {
    ...
    it("should categorize unresolvable non-relative imports as external by default", () => {
      ...
      expect(dependency.to.module.origin).toBe("external");
    });
    ...
    it("should not categorize paths outside rootPath as external by default", () => {
      ...
      expect(dependency.to.module.origin).toBe("local");
    });
  });
  ...
  describe("customSourcePatterns option", () => {
    it("should categorize imports matching patterns as external", () => {
      ...
      expect(dependency1.to.module.origin).toBe("external");
      expect(dependency2.to.module.origin).toBe("external");
    });
    ...
    it("should support complex glob patterns", () => {
      ...
      expect(external.to.module.origin).toBe("external");
      expect(local.to.module.origin).toBe("local");
    });
  });
  ...
  describe("logic with multiple conditions", () => {
    it("should categorize as external if ANY condition is true", () => {
      ...
      expect(dep1.to.module.origin).toBe("external");
      expect(dep2.to.module.origin).toBe("external");
      expect(dep3.to.module.origin).toBe("external");
      expect(dep4.to.module.origin).toBe("external");
    });
