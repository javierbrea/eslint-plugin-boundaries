...
The `boundaries/no-unknown` rule has been renamed to **[`boundaries/no-unknown-dependencies`](../../rules/no-unknown-dependencies.md)** and is now aware of [file descriptors](../../setup/files.md).
...
`mode: "file"` treated the element as the matched file itself. Migrate to [file descriptors](../../setup/files.md) with the [`boundaries/files`](../../setup/settings.md) setting:
...
:::info
Read more about `partialMatch` in the **[Elements](../../setup/elements.md#partialmatch-optional)** documentation.
:::
