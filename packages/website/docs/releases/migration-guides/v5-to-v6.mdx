...
- **[New object-based selector syntax](#object-based-elements-selector-syntax)**
- **[New dependency selector syntax](#dependencies-selector-syntax)**
- **[Renamed `boundaries/element-types` rule to `boundaries/dependencies`](#rule-element-types-renamed-to-dependencies)**
- **[Changed default value for `boundaries/dependency-nodes` setting](#changed-default-value-for-boundariesdependency-nodes-setting)** - ⚠️ Breaking change
- **[Deprecated rule-level `importKind` in favor of selector-level `dependency.kind`](#rule-level-importkind-is-deprecated)**
- **[New Handlebars-style template syntax](#new-template-syntax)**
- **[Deprecated `entry-point`, `external`, and `no-private` rules](#deprecated-rules)**
...
:::info
Read more about this change in the [GitHub discussion here](https://github.com/javierbrea/eslint-plugin-boundaries/discussions/362)
:::
