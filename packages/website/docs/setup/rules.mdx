...
The main rules ([`dependencies`](../rules/dependencies.md), [`external`](../rules/external.mdx) and [`entry-point`](../rules/entry-point.mdx)) share a common configuration format.
