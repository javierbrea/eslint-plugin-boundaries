...
The main rules ([`element-types`](../rules/dependencies.md), [`external`](../rules/external.md) and [`entry-point`](../rules/entry-point.md)) share a common configuration format.
...
{
  to: [
    { type: "components", captured: { family: "atoms" } },
    { type: "helpers"}
  ]
}
```
...
:::tip
Check each specific [rule’s documentation](../rules/rules.md) for the complete list of `report` properties supported.
:::
...
```js
{
  ...
  rules: [
    ...
    {
      from: { type: "components", captured: { family: "atoms" } },
      disallow: { to: { type: "helpers", captured: { domain: "api" } } },
    },
    ...
    // Component family "atoms" can import "api/fetcher" helper, in exception to previous rule
    {
      from: { type: "components", captured: { family: "atoms" } },
      allow: {
        to: { type: "helpers", captured: { domain: "api", elementName: "fetcher" } }
      }
    }
  ]
}
    ...
    "boundaries/element-types": [2, {
      ...
      rules: [
        ...
        },
        {
          ...
          allow: {
            to: [
              ...
              { type: "components", captured: { family: "{{from.family}}" } },
                // allow importing helpers with domain "data"
              { type: "helpers", captured: { domain: "data" } }
            ]
          }
        },
        {
        ...
        },
        {
          ...
          from: { type: "components", captured: { family: "atom" } },
          disallow: {
            // disallow importing helpers with domain "data"
            to: { type: "helpers", captured: { domain: "data" } }
          },
        ...
        },
        {
          ...
          from: { type: "modules", captured: { elementName: "page-*" } },
          disallow: {
            // disallow importing any type of component not being of family layout
            to: { type: "components", captured: { family: "!layout" } },
          },
          // Custom message only for this specific error
          message: `
