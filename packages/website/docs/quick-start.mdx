...
Apply one of the [predefined rule configurations](./setup/setup.md) as a starting point by extending it in your `rules` section.
...
* Explore the **[Setup section](./setup/setup.md)** to learn more about **assigning Element Types and using Element Selectors**.
* Review the **[Rules section](./rules/overview/overview.md)** to understand **all available rules and how to configure them**.
* Visit the **[Error Messages section](./rules/overview/error-messages.md)** to learn **what each error means and how to customize the messages**.
