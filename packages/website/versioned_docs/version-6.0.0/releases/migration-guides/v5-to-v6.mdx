...
The boundaries set by this rule now can also be achieved with the **[`boundaries/dependencies` rule](../../rules/dependencies.md)**, which allows you to specify allowed entry points directly in the rules by **using the new [`internalPath` selector property](../../setup/selectors.md).**
...
The boundaries set by this rule can also be achieved with the **[`boundaries/dependencies` rule](../../rules/dependencies.md)**, which allows you to specify allowed entry points directly in the rules by **using the [`origin`, `source`, `module`, 'internalPath' and `specifiers` selector properties](../../setup/selectors.md).**
...
The boundaries set by this rule can also be achieved with the **[`boundaries/dependencies` rule](../../rules/dependencies.md)**, which allows you to specify allowed entry points directly in the rules by **using the [`relationship` selector property](../../setup/selectors.md).**
