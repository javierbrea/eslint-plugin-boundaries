...
testPrivate(
  ...
  pathResolvers("two-levels-with-private"),
  {
    0: 'Dependencies to elements of type "components" and captured values: category="atoms", elementName="atom-a" are not allowed in elements of type "helpers" and captured values: elementName="helper-c". Denied by rule at index 0',
    1: 'Dependencies to elements of type "modules" and captured values: domain="domain-a", elementName="module-a" are not allowed in elements of type "helpers" and captured values: elementName="helper-c". Denied by rule at index 1',
    2: 'Dependencies to elements of type "components" and captured values: category="molecules" are not allowed in elements of type "components" and captured values: category="atoms". Denied by rule at index 2',
    3: 'Dependencies to elements of type "components" and captured values: category="molecules" are not allowed in elements of type "components" and captured values: category="atoms". Denied by rule at index 2',
    4: 'Dependencies to elements of type "components" and captured values: category="layouts" are not allowed in elements of type "components" and captured values: category="molecules". Denied by rule at index 3',
    5: 'Dependencies to elements of type "modules" are not allowed in elements of type "components" and captured values: category="molecules". Denied by rule at index 4',
    6: 'Dependencies to elements of type "modules" are not allowed in elements of type "components" and captured values: category="layouts". Denied by rule at index 4',
    7: 'Dependencies to elements of type "components" and captured values: category="molecules" are not allowed in elements of type "modules" and captured values: domain="pages". Denied by rule at index 6',
    8: 'Dependencies to elements of type "modules" and captured values: domain="domain-a" are not allowed in elements of type "modules" and captured values: domain="pages". Denied by rule at index 5',
    9: 'Dependencies to elements of type "components" and captured values: category="molecules" are not allowed in elements of type "modules" and captured values: domain="domain-a". Denied by rule at index 7',
    10: 'Dependencies to elements of type "modules" and captured values: domain="pages" are not allowed in elements of type "modules" and captured values: domain="domain-a". Denied by rule at index 9',
    11: 'Dependencies to elements of type "modules" and captured values: domain="domain-b" are not allowed in elements of type "modules" and captured values: domain="domain-a". Denied by rule at index 9',
  }
);
