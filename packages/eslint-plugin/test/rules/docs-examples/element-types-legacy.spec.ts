  ...
  invalid: [
    // Helpers can't import component
    {
      ...
      errors: [
        {
          message:
            'There is no rule allowing dependencies from elements of type "helpers" and captured values: category="permissions", elementName="roles" to elements of type "components" and captured values: family="atoms", elementName="atom-a"',
          type: "Literal",
        },
      ],
    },
    // Helpers can't import modules
    {
      ...
      errors: [
        {
          message:
            'There is no rule allowing dependencies from elements of type "helpers" and captured values: category="permissions", elementName="roles" to elements of type "modules" and captured values: elementName="module-a"',
          type: "Literal",
        },
      ],
    },
    ...
    // Components can't import helpers of a category different to "data"
    {
      ...
      errors: [
        {
          message:
            'There is no rule allowing dependencies from elements of type "components" and captured values: family="atoms", elementName="atom-a" to elements of type "helpers" and captured values: category="permissions", elementName="roles"',
          type: "Literal",
        },
      ],
    },
