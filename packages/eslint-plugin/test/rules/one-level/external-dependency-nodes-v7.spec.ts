    ...
    policies: [
        ...
        disallow: [
          {
            ...
            dependency: { kind: "type", specifiers: ["Link"] },
          },
        ],
      },
      // Modules can't import Link value from react-router-dom
      {
        ...
        disallow: [
          {
            to: { module: { origin: "external", source: "react-router-dom" } },
            dependency: { kind: "value", specifiers: ["Link"] },
          },
        ],
      },
  ...
  invalid: [
    ...
    // Modules can't export a value from react
    {
      ...
      errors: [
        {
          message:
            'Dependencies with module source "react" to entities of module with origin "external" are not allowed in elements of type "modules". Denied by policy at index 2',
          type: "Literal",
        },
      ],
    },
