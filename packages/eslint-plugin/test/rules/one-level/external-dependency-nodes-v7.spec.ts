  ...
  invalid: [
    ...
    // Modules can't export a value from react
    {
      ...
      errors: [
        {
          message:
            'Dependencies with module source "react" to entities of module with origin "external" are not allowed in elements of type "modules". Denied by rule at index 2',
          type: "Literal",
        },
      ],
    },
