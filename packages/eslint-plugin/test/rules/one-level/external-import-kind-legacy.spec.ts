...
runTest(
  ...
  {
    0: 'Dependencies with kind "value" and module source "react" to entities of module with origin "external" are not allowed in elements of type "helpers". Denied by rule at index 0',
    1: 'Dependencies with kind "type" and module source "react-router-dom" to entities of module with origin "external" are not allowed in elements of type "components". Denied by rule at index 1',
    2: 'Dependencies with kind "value", module source "foo-library" and specifiers "Link" to entities of module with origin "external" are not allowed in elements of type "helpers". Denied by rule at index 0',
    3: 'Dependencies with kind "value", module source "foo-library" and specifiers "Link" to entities of module with origin "external" are not allowed in elements of type "helpers". Denied by rule at index 0',
    4: 'Dependencies with kind "value", module source "foo-library" and specifiers "Link", "Foo" to entities of module with origin "external" are not allowed in elements of type "helpers". Denied by rule at index 0',
    5: 'Dependencies with kind "value", module source "foo-library" and specifiers "Link", "Foo" to entities of module with origin "external" are not allowed in elements of type "helpers". Denied by rule at index 0',
    6: 'Dependencies with kind "value", module source "foo-library" and specifiers "Link", "Router" to entities of module with origin "external" are not allowed in elements of type "helpers". Denied by rule at index 0',
    7: 'Dependencies with kind "type" and module source "@material-ui/core" to entities of module with origin "external" are not allowed in elements of type "modules". Denied by rule at index 2',
    8: 'Dependencies with kind "value" and module source "@material-ui/core" to entities of module with origin "external" are not allowed in elements of type "modules". Denied by rule at index 2',
    9: 'Dependencies with kind "value", module source "react-router-dom" and module internalPath "var/foo" to entities of module with origin "external" are not allowed in elements of type "modules". Denied by rule at index 2',
    10: 'Dependencies with kind "type", module source "react-router-dom" and module internalPath "var/foo" to entities of module with origin "external" are not allowed in elements of type "modules". Denied by rule at index 2',
    11: 'Dependencies with kind "type" and module source "@material-ui/icons" to entities of module with origin "external" are not allowed in elements of type "modules". Denied by rule at index 2',
    12: 'Dependencies with kind "type" and module source "@material-ui/icons" to entities of module with origin "external" are not allowed in elements of type "modules". Denied by rule at index 2',
  }
);
...
runTest(
  ...
  ],
  {
    ...
    2: 'Dependencies with kind "value", module source "foo-library" and specifiers "Link" to entities of module with origin "external" are not allowed in elements of type "helpers". Denied by rule at index 1',
    3: 'Dependencies with kind "value", module source "foo-library" and specifiers "Link" to entities of module with origin "external" are not allowed in elements of type "helpers". Denied by rule at index 1',
    4: 'Dependencies with kind "value", module source "foo-library" and specifiers "Link", "Foo" to entities of module with origin "external" are not allowed in elements of type "helpers". Denied by rule at index 1',
    5: 'Dependencies with kind "value", module source "foo-library" and specifiers "Link", "Foo" to entities of module with origin "external" are not allowed in elements of type "helpers". Denied by rule at index 1',
