...
runTest(
  ...
  ],
  {
    ...
    4: 'Dependencies with kind "value", module "foo-library" and specifiers "Link", "Foo" to elements of origin "external" and internalPath "" are not allowed in elements of type "helpers". Denied by rule at index 0',
    5: 'Dependencies with kind "value", module "foo-library" and specifiers "Link", "Foo" to elements of origin "external" and internalPath "" are not allowed in elements of type "helpers". Denied by rule at index 0',
    6: 'Dependencies with kind "value", module "foo-library" and specifiers "Link", "Router" to elements of origin "external" and internalPath "" are not allowed in elements of type "helpers". Denied by rule at index 0',
...
runTest(
  ...
  ],
  {
    ...
    2: 'Dependencies with kind "value", module "foo-library" and specifiers "Link" to elements of origin "external" and internalPath "" are not allowed in elements of type "helpers". Denied by rule at index 1',
    3: 'Dependencies with kind "value", module "foo-library" and specifiers "Link" to elements of origin "external" and internalPath "" are not allowed in elements of type "helpers". Denied by rule at index 1',
    4: 'Dependencies with kind "value", module "foo-library" and specifiers "Link", "Foo" to elements of origin "external" and internalPath "" are not allowed in elements of type "helpers". Denied by rule at index 1',
    5: 'Dependencies with kind "value", module "foo-library" and specifiers "Link", "Foo" to elements of origin "external" and internalPath "" are not allowed in elements of type "helpers". Denied by rule at index 1',
    6: 'Dependencies with kind "value", module "foo-library" and specifiers "Link", "Router" to elements of origin "external" and internalPath "" are not allowed in elements of type "helpers". Denied by rule at index 1',
