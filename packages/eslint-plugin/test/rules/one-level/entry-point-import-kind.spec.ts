...
const precedenceRuleTester = createRuleTester(TYPESCRIPT_SETTINGS.oneLevel);
      ...
      options: [
        {
          ...
          rules: [
            {
              target: { type: "helpers", kind: "value" },
              allow: "main.js",
              importKind: "type",
            },
          ],
  ...
  invalid: [
    {
      ...
      errors: [
        {
          message:
            "No rule allows the entry point 'main.js' in dependencies of type 'helpers' with elementName 'helper-a'",
          type: "Literal",
        },
      ],
    },
