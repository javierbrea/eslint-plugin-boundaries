...
runTest(
  ...
  ],
  {
    ...
    8: 'Dependencies with source "react-router-dom/var/foo" and module "react-router-dom" to entities of origin "external" are not allowed in elements of type "modules". Denied by rule at index 5',
  }
);
