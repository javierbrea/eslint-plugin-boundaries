      ...
      rules: [
        {
          ...
          disallow: [
            { to: { element: { type: "modules" } }, dependency: { kind: "*" } },
          ],
        },
        {
          from: {
      ...
      rules: [
        ...
        },
        {
          ...
          allow: [
            ...
            { to: { element: { type: "helpers" } }, dependency: { kind: "*" } },
          ],
        },
        {
          from: { element: { type: "components" } },
      ...
      rules: [
        {
          ...
          message:
            "Do not import {{ dependency.kind }} from {{ to.element.types.[0] }} in {{ from.element.types.[0] }}",
        },
        {
          from: { element: { type: "helpers" } },
          disallow: [
