...
const { DEPENDENCIES: RULE } = require("../../../src/Shared");
...
runTest(
  ...
  {
    0: 'There is no rule allowing dependencies from elements of type "code" and category "helpers" to elements of type "code" and category "helpers"',
