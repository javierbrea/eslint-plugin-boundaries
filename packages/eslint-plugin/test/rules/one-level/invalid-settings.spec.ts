...
const runTest = (
  ...
  options: unknown[],
  {
    0: errorMessage0 = 'There is no policy allowing dependencies from elements of type "helpers" and captured values: elementName="helper-a" to elements of type "helpers" and captured values: elementName="helper-b"',
