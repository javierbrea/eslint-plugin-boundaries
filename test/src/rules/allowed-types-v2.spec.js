const { ALLOWED_TYPES_V2: RULE } = require("../../../src/constants/rules");

const { createRuleTester, absoluteFilePath, codeFilePath } = require("../helpers");

const rule = require(`../../../src/rules/${RULE}`);

const settings = {
  // "boundaries/ignore": ["**/components/**/*"],
  "boundaries/types": [
    {
      name: "components",
